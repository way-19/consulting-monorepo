...
const CountryPage = () => {
  ...
  const countryData = {
    ...
    'costa-rica': {
      name: 'Costa Rica',
      flag: '🇨🇷',
      description: 'Stable democracy in Central America with strong environmental policies, business-friendly regulations, and strategic location.',
      capital: 'San José',
      language: 'Spanish, English',
      currency: 'Costa Rican Colón (CRC)',
      timezone: 'GMT-6',
      heroImage: 'https://images.pexels.com/photos/1430676/pexels-photo-1430676.jpeg?auto=compress&cs=tinysrgb&w=1920',
      businessAdvantages: [
        'Political stability and democracy',
        'No standing army since 1948',
        'Strong environmental protection laws',
        'Strategic location between North and South America',
        'Free trade zones available',
        'Educated workforce',
      ...
      consultant: {
        ...
        name: 'Carlos Mendez',
        title: 'Senior Business Consultant',
        company: 'Mendez Business Solutions',
        experience: '6+ years',
        rating: 4.7,
        clients: 25,
        avatar: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=400',
        specializations: ['Company Formation', 'Investment Incentives', 'Free Trade Zones', 'Environmental Compliance'],
        languages: ['Spanish', 'English'],
      },
      services: [
        {
          title: 'Costa Rica Corporation Formation',
          description: 'Complete corporation setup with all legal requirements and registrations',
          duration: '3-4 weeks',
          features: ['Corporation registration', 'Tax registration', 'Municipal permits', 'Legal compliance setup', 'Ongoing support'],
          category: 'Company Formation',
          image: 'https://images.pexels.com/photos/1430676/pexels-photo-1430676.jpeg?auto=compress&cs=tinysrgb&w=800',
          link: '/services/costa-rica/corporation-formation',
        },
        {
          title: 'Free Trade Zone Setup',
          description: 'Establish your business in Costa Rica\'s free trade zones with tax benefits',
          duration: '4-6 weeks',
          features: ['FTZ application', 'Tax incentives', 'Export benefits', 'Regulatory compliance', 'Ongoing advisory'],
          category: 'Tax Optimization',
          image: 'https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=800',
          link: '/services/costa-rica/free-trade-zone',
        },
        {
          title: 'Investment Incentives',
          description: 'Access Costa Rica\'s investment promotion programs and incentives',
          duration: '2-3 weeks',
          features: ['Incentive assessment', 'Application support', 'Documentation', 'Government liaison', 'Compliance monitoring'],
          category: 'Investment',
          image: 'https://images.pexels.com/photos/4386321/pexels-photo-4386321.jpeg?auto=compress&cs=tinysrgb&w=800',
          link: '/services/costa-rica/investment-incentives',
        },
        {
          title: 'Banking Solutions',
          description: 'Corporate banking account opening and financial services in Costa Rica',
          duration: '2-3 weeks',
          features: ['Bank account opening', 'Multi-currency accounts', 'Payment processing', 'Banking relationships', 'Ongoing support'],
          category: 'Banking',
          image: 'https://images.pexels.com/photos/259027/pexels-photo-259027.jpeg?auto=compress&cs=tinysrgb&w=800',
          link: '/services/costa-rica/banking-solutions',
        },
        {
          title: 'Residency Services',
          description: 'Obtain Costa Rican residency through investment or other programs',
          duration: '6-12 months',
          features: ['Residency application', 'Document preparation', 'Legal representation', 'Application tracking', 'Renewal assistance'],
          category: 'Immigration',
          image: 'https://images.pexels.com/photos/4386321/pexels-photo-4386321.jpeg?auto=compress&cs=tinysrgb&w=800',
          link: '/services/costa-rica/residency-services',
        },
        {
          title: 'Environmental Compliance',
          description: 'Navigate Costa Rica\'s environmental regulations and obtain permits',
          duration: '2-4 weeks',
          features: ['Environmental assessment', 'Permit applications', 'Compliance monitoring', 'Regulatory updates', 'Ongoing support'],
          category: 'Legal Compliance',
          image: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=800',
          link: '/services/costa-rica/environmental-compliance',
        },
      ],
      stats: {
        companiesFormed: 85,
        avgFormationTime: '3.5 weeks',
        successRate: '95%',
        clientSatisfaction: 4.7,
      },
      keyFacts: [
        { label: 'Corporate Tax Rate', value: '30%', icon: DollarSign },
        { label: 'FTZ Tax Rate', value: '0%', icon: TrendingUp },
        { label: 'Formation Time', value: '3-4 weeks', icon: Building2 },
        { label: 'Minimum Capital', value: '$2,000', icon: Shield },
      ],
    },
  };
