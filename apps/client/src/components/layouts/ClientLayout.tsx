...
const ClientLayout: React.FC<ClientLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Accounting', href: '/client/accounting', icon: BarChart3 },
    { name: 'File Manager', href: '/client/files', icon: FileText },
    { name: 'Mailbox', href: '/client/mailbox', icon: Mail },
    { name: 'Progress', href: '/client/reports', icon: BarChart3 },
                ...
                <li key={item.name}>
                  <Link
                    ...
                    className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                      isActive
                        ? 'bg-blue-50 text-blue-700 shadow-lg border-l-4 border-blue-600'
