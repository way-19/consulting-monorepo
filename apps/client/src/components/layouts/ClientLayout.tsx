...
const ClientLayout: React.FC<ClientLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Accounting', href: '/client/documents', icon: BarChart3 },
    { name: 'File Manager', href: '/client/file-manager', icon: FileText },
      ...
      <div className="w-64 bg-white shadow-lg flex flex-col border-r border-gray-200">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-teal-600 rounded-lg flex items-center justify-center shadow-lg">
